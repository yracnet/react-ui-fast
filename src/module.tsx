...
export declare type FilterTextValue = FilterTextState;
export declare type FilterTextChange = FilterTextChange;
...
export declare type InputTextState = InputTextState;
